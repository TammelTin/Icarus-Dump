...
struct UAfricanElephant_M_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function AfricanElephant_M_AnimBP.AfricanElephant_M_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void CalcRotationRate(float CurrentYaw, float YawRotationRate); // Function AfricanElephant_M_AnimBP.AfricanElephant_M_AnimBP_C.CalcRotationRate // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function AfricanElephant_M_AnimBP.AfricanElephant_M_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void BlueprintBeginPlay(); // Function AfricanElephant_M_AnimBP.AfricanElephant_M_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void SetIKEnabled(bool Value); // Function AfricanElephant_M_AnimBP.AfricanElephant_M_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_AfricanElephant_M_AnimBP(int32_t EntryPoint); // Function AfricanElephant_M_AnimBP.AfricanElephant_M_AnimBP_C.ExecuteUbergraph_AfricanElephant_M_AnimBP // (Final|UbergraphFunction) // @ game+0x1a05090
};
