...
struct ABP_IcarusDropShipSpawn_C : AIcarusRocketSpawnBase {
	...
	int32_t GetGroupIndex(); // Function BP_IcarusDropShipSpawn.BP_IcarusDropShipSpawn_C.GetGroupIndex // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x1a05090
	void UserConstructionScript(); // Function BP_IcarusDropShipSpawn.BP_IcarusDropShipSpawn_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
};
