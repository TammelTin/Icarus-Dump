...
struct ABP_InteractionScene_C : AActor {
	...
	void UpdateInteractionScreen(bool Interacting); // Function BP_InteractionScene.BP_InteractionScene_C.UpdateInteractionScreen // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void UserConstructionScript(); // Function BP_InteractionScene.BP_InteractionScene_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
};
