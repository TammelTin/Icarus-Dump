...
struct ABP_MetaDeposit_Arctic_C : ABP_MetaDeposit_C {
	...
	void Timeline_FadeOut__FinishedFunc(); // Function BP_MetaDeposit_Arctic.BP_MetaDeposit_Arctic_C.Timeline_FadeOut__FinishedFunc // (BlueprintEvent) // @ game+0x1a05090
	void Timeline_FadeOut__UpdateFunc(); // Function BP_MetaDeposit_Arctic.BP_MetaDeposit_Arctic_C.Timeline_FadeOut__UpdateFunc // (BlueprintEvent) // @ game+0x1a05090
	void ResourceEmptied(); // Function BP_MetaDeposit_Arctic.BP_MetaDeposit_Arctic_C.ResourceEmptied // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_BP_MetaDeposit_Arctic(int32_t EntryPoint); // Function BP_MetaDeposit_Arctic.BP_MetaDeposit_Arctic_C.ExecuteUbergraph_BP_MetaDeposit_Arctic // (Final|UbergraphFunction) // @ game+0x1a05090
};
