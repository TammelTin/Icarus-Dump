...
struct ABP_MetaDeposit_Desert_C : ABP_MetaDeposit_C {
	...
	void Timeline_FadeOut__FinishedFunc(); // Function BP_MetaDeposit_Desert.BP_MetaDeposit_Desert_C.Timeline_FadeOut__FinishedFunc // (BlueprintEvent) // @ game+0x1a05090
	void Timeline_FadeOut__UpdateFunc(); // Function BP_MetaDeposit_Desert.BP_MetaDeposit_Desert_C.Timeline_FadeOut__UpdateFunc // (BlueprintEvent) // @ game+0x1a05090
	void ResourceEmptied(); // Function BP_MetaDeposit_Desert.BP_MetaDeposit_Desert_C.ResourceEmptied // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_BP_MetaDeposit_Desert(int32_t EntryPoint); // Function BP_MetaDeposit_Desert.BP_MetaDeposit_Desert_C.ExecuteUbergraph_BP_MetaDeposit_Desert // (Final|UbergraphFunction) // @ game+0x1a05090
};
