...
struct ABP_NPC_Chamois_M_Character_C : ABP_IcarusNPCGOAPCharacter_C {
	...
	void GetAlertWidgetLocation(struct FVector Location); // Function BP_NPC_Chamois_M_Character.BP_NPC_Chamois_M_Character_C.GetAlertWidgetLocation // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void FindFloorAngle(float Angle); // Function BP_NPC_Chamois_M_Character.BP_NPC_Chamois_M_Character_C.FindFloorAngle // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a05090
};
