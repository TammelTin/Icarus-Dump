...
struct ABP_Thatch_Ladder_C : ABP_DeployableBase_C {
	...
	void Deployable_Interact(struct AActor* Interactor); // Function BP_Thatch_Ladder.BP_Thatch_Ladder_C.Deployable_Interact // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	...
	void ExecuteUbergraph_BP_Thatch_Ladder(int32_t EntryPoint); // Function BP_Thatch_Ladder.BP_Thatch_Ladder_C.ExecuteUbergraph_BP_Thatch_Ladder // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
