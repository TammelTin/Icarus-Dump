...
struct ABP_VehicleTrailer_Test_C : ABP_VehicleTrailer_C {
	...
	void OnRep_VehicleConstraintAttachments(); // Function BP_VehicleTrailer_Test.BP_VehicleTrailer_Test_C.OnRep_VehicleConstraintAttachments // (Event|Protected|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_BP_VehicleTrailer_Test(int32_t EntryPoint); // Function BP_VehicleTrailer_Test.BP_VehicleTrailer_Test_C.ExecuteUbergraph_BP_VehicleTrailer_Test // (Final|UbergraphFunction) // @ game+0x1a05090
};
