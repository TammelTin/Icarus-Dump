...
struct ABP_WorldObject_C : AIcarusActor {
	...
	void WorldObject_Held_Interact(struct AActor* Instigator); // Function BP_WorldObject.BP_WorldObject_C.WorldObject_Held_Interact // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void WorldObject_Interact(struct AActor* Instigator); // Function BP_WorldObject.BP_WorldObject_C.WorldObject_Interact // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
};
