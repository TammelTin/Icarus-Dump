...
struct UCF_DebugArmor_C : UCF_BaseButton_C {
	...
	void Execute(); // Function CF_DebugArmor.CF_DebugArmor_C.Execute // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_CF_DebugArmor(int32_t EntryPoint); // Function CF_DebugArmor.CF_DebugArmor_C.ExecuteUbergraph_CF_DebugArmor // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
