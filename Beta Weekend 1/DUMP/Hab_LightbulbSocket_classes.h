...
struct AHab_LightbulbSocket_C : AIcarusActor {
	...
	void OverridePowerState(enum class EPowerStates PowerStateOverride); // Function Hab_LightbulbSocket.Hab_LightbulbSocket_C.OverridePowerState // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void UserConstructionScript(); // Function Hab_LightbulbSocket.Hab_LightbulbSocket_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
};
