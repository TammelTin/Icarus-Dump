...
struct UBaseBrushTool : UMeshSurfacePointTool {
	...
	struct FBrushStampData LastBrushStamp; // 0xd0(0xac)
	char pad_17C[0x14]; // 0x17c(0x14)
	struct TSoftClassPtr<UObject> PropertyClass; // 0x190(0x28)
...
struct UGizmoBaseComponent : UPrimitiveComponent {
	struct FLinearColor Color; // 0x440(0x10)
	float HoverSizeMultiplier; // 0x450(0x04)
	float PixelHitDistanceThreshold; // 0x454(0x04)
	char pad_458[0x8]; // 0x458(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x35ae370
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x35ae2e0
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x480 (Inherited: 0x460)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x460(0x0c)
	float Gap; // 0x46c(0x04)
	float Length; // 0x470(0x04)
	float Thickness; // 0x474(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x460(0x0c)
	char pad_46C[0x4]; // 0x46c(0x04)
	struct FQuat Rotation; // 0x470(0x10)
	struct FVector Dimensions; // 0x480(0x0c)
	float LineThickness; // 0x48c(0x04)
	bool bRemoveHiddenLines; // 0x490(0x01)
	bool bEnableAxisFlip; // 0x491(0x01)
...
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x460(0x0c)
	float Radius; // 0x46c(0x04)
	float Thickness; // 0x470(0x04)
	int32_t NumSides; // 0x474(0x04)
	bool bViewAligned; // 0x478(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x479(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x35ae170
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x35adfe0
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x14c44f0
	void GetTangentVectors(struct FVector TangentXOut, struct FVector TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x35adef0
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x14c41b0
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x35ade70
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0x35ae250
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x35ade10
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x35ade30
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x35ae050
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x14d3140
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x35ade50
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x35ade10
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x35ae0e0
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x35adeb0
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x35ade50
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x35ade10
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x460(0x0c)
	float HandleSize; // 0x46c(0x04)
	float Thickness; // 0x470(0x04)
	struct FVector Direction; // 0x474(0x0c)
	float Length; // 0x480(0x04)
	bool bImageScale; // 0x484(0x01)
...
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x460(0x0c)
	struct FVector DirectionY; // 0x46c(0x0c)
	float OffsetX; // 0x478(0x04)
	float OffsetY; // 0x47c(0x04)
	float LengthX; // 0x480(0x04)
	float LengthY; // 0x484(0x04)
	float Thickness; // 0x488(0x04)
	char SegmentFlags; // 0x48c(0x01)
