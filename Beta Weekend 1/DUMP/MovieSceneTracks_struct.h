...
struct FMovieSceneCameraShakeSectionData {
	struct UMatineeCameraShake* ShakeClass; // 0x00(0x08)
...
struct FMovieSceneColorSectionTemplate : FMovieScenePropertySectionTemplate {
	struct FMovieSceneFloatChannel Curves[0x4]; // 0x38(0x280)
	enum class EMovieSceneBlendType BlendType; // 0x2b8(0x01)
...
struct FMovieSceneVectorPropertySectionTemplate : FMovieScenePropertySectionTemplate {
	struct FMovieSceneFloatChannel ComponentCurves[0x4]; // 0x38(0x280)
	int32_t NumChannelsUsed; // 0x2b8(0x04)
	enum class EMovieSceneBlendType BlendType; // 0x2bc(0x01)
...
struct FMovieSceneIntegerPropertySectionTemplate : FMovieScenePropertySectionTemplate {
	struct FMovieSceneIntegerChannel IntegerCurve; // 0x38(0x90)
	enum class EMovieSceneBlendType BlendType; // 0xc8(0x01)
...
struct FMovieSceneEnumPropertySectionTemplate : FMovieScenePropertySectionTemplate {
	struct FMovieSceneByteChannel EnumCurve; // 0x38(0x98)
};
...
struct FMovieSceneBytePropertySectionTemplate : FMovieScenePropertySectionTemplate {
	struct FMovieSceneByteChannel ByteCurve; // 0x38(0x98)
};
