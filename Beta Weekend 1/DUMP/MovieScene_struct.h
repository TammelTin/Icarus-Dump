...
struct FMovieScenePropertyBinding {
	struct FName PropertyName; // 0x00(0x08)
	struct FName PropertyPath; // 0x08(0x08)
	bool bCanUseClassLookup; // 0x10(0x01)
	char pad_11[0x3]; // 0x11(0x03)
};
...
struct FMovieSceneEvaluationTrack {
	...
	struct FName EvaluationGroup; // 0x68(0x08)
	char bEvaluateInPreroll : 1; // 0x70(0x01)
	char bEvaluateInPostroll : 1; // 0x70(0x01)
	char bTearDownPriority : 1; // 0x70(0x01)
...
struct FMovieSceneSubSequenceData {
	...
	int16_t HierarchicalBias; // 0x94(0x02)
	bool bHasHierarchicalEasing; // 0x96(0x01)
