...
struct UMuleDeer_Y_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function MuleDeer_Y_AnimBP.MuleDeer_Y_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	float GetIKStrength(); // Function MuleDeer_Y_AnimBP.MuleDeer_Y_AnimBP_C.GetIKStrength // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a05090
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function MuleDeer_Y_AnimBP.MuleDeer_Y_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void BlueprintBeginPlay(); // Function MuleDeer_Y_AnimBP.MuleDeer_Y_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void SetIKEnabled(bool Value); // Function MuleDeer_Y_AnimBP.MuleDeer_Y_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_MuleDeer_Y_AnimBP(int32_t EntryPoint); // Function MuleDeer_Y_AnimBP.MuleDeer_Y_AnimBP_C.ExecuteUbergraph_MuleDeer_Y_AnimBP // (Final|UbergraphFunction) // @ game+0x1a05090
};
