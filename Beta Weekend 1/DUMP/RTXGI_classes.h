...
struct UDDGIBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void EnableVolume(struct UDDGIVolumeComponent* DDGIVolumeComponent); // Function RTXGI.DDGIBlueprintLibrary.EnableVolume // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xf51bc0
	void DisableVolume(struct UDDGIVolumeComponent* DDGIVolumeComponent); // Function RTXGI.DDGIBlueprintLibrary.DisableVolume // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xf51b40
	void ClearProbeData(struct UDDGIVolumeComponent* DDGIVolumeComponent); // Function RTXGI.DDGIBlueprintLibrary.ClearProbeData // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xf51aa0
};
...
struct UDDGIVolumeComponent : USceneComponent {
	...
	void DDGIClearVolumes(); // Function RTXGI.DDGIVolumeComponent.DDGIClearVolumes // (Final|Exec|Native|Public) // @ game+0xf51b20
};
