...
struct USK_BOW_Crossbow_02_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_BOW_Crossbow_02_AnimBP.SK_BOW_Crossbow_02_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK_BOW_Crossbow_02_AnimBP.SK_BOW_Crossbow_02_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_SK_BOW_Crossbow_02_AnimBP(int32_t EntryPoint); // Function SK_BOW_Crossbow_02_AnimBP.SK_BOW_Crossbow_02_AnimBP_C.ExecuteUbergraph_SK_BOW_Crossbow_02_AnimBP // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
