...
struct USK_BOW_Longbow_AnimBP_C : UIcarusBowAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_BOW_Longbow_AnimBP.SK_BOW_Longbow_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	bool IsHandConnectedToString(); // Function SK_BOW_Longbow_AnimBP.SK_BOW_Longbow_AnimBP_C.IsHandConnectedToString // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a05090
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK_BOW_Longbow_AnimBP.SK_BOW_Longbow_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void AnimNotify_Bow_AttachArrow(); // Function SK_BOW_Longbow_AnimBP.SK_BOW_Longbow_AnimBP_C.AnimNotify_Bow_AttachArrow // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void AnimNotify_Bow_DetachArrow(); // Function SK_BOW_Longbow_AnimBP.SK_BOW_Longbow_AnimBP_C.AnimNotify_Bow_DetachArrow // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_SK_BOW_Longbow_AnimBP(int32_t EntryPoint); // Function SK_BOW_Longbow_AnimBP.SK_BOW_Longbow_AnimBP_C.ExecuteUbergraph_SK_BOW_Longbow_AnimBP // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
