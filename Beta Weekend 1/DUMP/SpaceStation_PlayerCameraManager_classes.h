...
struct ASpaceStation_PlayerCameraManager_C : APlayerCameraManager {
	...
	void InteractionChangedCheck(); // Function SpaceStation_PlayerCameraManager.SpaceStation_PlayerCameraManager_C.InteractionChangedCheck // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
