...
struct UUMG_MissionCompleteFaction_C : UUserWidget {
	...
	void Update(bool Success, struct FFactionMissionsRowHandle FactionMission); // Function UMG_MissionCompleteFaction.UMG_MissionCompleteFaction_C.Update // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
};
