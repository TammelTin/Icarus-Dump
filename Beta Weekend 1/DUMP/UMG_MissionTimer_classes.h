...
struct UUMG_MissionTimer_C : UUserWidget {
	...
	void SetTime(struct TArray<struct FString> Time); // Function UMG_MissionTimer.UMG_MissionTimer_C.SetTime // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UMG_MissionTimer.UMG_MissionTimer_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_UMG_MissionTimer(int32_t EntryPoint); // Function UMG_MissionTimer.UMG_MissionTimer_C.ExecuteUbergraph_UMG_MissionTimer // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
