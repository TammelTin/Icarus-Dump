...
struct UUMG_RadarSquare_C : UUMG_IcarusLinkedActorPanel_C {
	...
	void Construct(); // Function UMG_RadarSquare.UMG_RadarSquare_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_UMG_RadarSquare(int32_t EntryPoint); // Function UMG_RadarSquare.UMG_RadarSquare_C.ExecuteUbergraph_UMG_RadarSquare // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
