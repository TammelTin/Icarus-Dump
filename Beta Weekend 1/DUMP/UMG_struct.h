...
struct FMovieSceneMarginSectionTemplate : FMovieScenePropertySectionTemplate {
	struct FMovieSceneFloatChannel TopCurve; // 0x38(0xa0)
	struct FMovieSceneFloatChannel LeftCurve; // 0xd8(0xa0)
	struct FMovieSceneFloatChannel RightCurve; // 0x178(0xa0)
	struct FMovieSceneFloatChannel BottomCurve; // 0x218(0xa0)
