...
struct Utrailer_TEST_Skeleton_AnimBlueprint_C : UVehicleAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function trailer_TEST_Skeleton_AnimBlueprint.trailer_TEST_Skeleton_AnimBlueprint_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_trailer_TEST_Skeleton_AnimBlueprint(int32_t EntryPoint); // Function trailer_TEST_Skeleton_AnimBlueprint.trailer_TEST_Skeleton_AnimBlueprint_C.ExecuteUbergraph_trailer_TEST_Skeleton_AnimBlueprint // (Final|UbergraphFunction) // @ game+0x1a05090
};
