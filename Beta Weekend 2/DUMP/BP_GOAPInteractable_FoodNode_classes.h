...
struct ABP_GOAPInteractable_FoodNode_C : ABP_GOAPInteractable_Base_C {
	...
	void OnInteractionComplete(struct AIcarusNPCGOAPController* Controller); // Function BP_GOAPInteractable_FoodNode.BP_GOAPInteractable_FoodNode_C.OnInteractionComplete // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
};
