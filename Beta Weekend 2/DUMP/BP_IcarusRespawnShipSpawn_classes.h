...
struct ABP_IcarusRespawnShipSpawn_C : AIcarusActor {
	...
	void UpdateBiomeValue(); // Function BP_IcarusRespawnShipSpawn.BP_IcarusRespawnShipSpawn_C.UpdateBiomeValue // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void UnassignSpawn(); // Function BP_IcarusRespawnShipSpawn.BP_IcarusRespawnShipSpawn_C.UnassignSpawn // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void AssignSpawn(struct FString PlayerID); // Function BP_IcarusRespawnShipSpawn.BP_IcarusRespawnShipSpawn_C.AssignSpawn // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void UserConstructionScript(); // Function BP_IcarusRespawnShipSpawn.BP_IcarusRespawnShipSpawn_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
};
