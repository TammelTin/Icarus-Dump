...
struct ABP_InteractionWidget_C : AActor {
	...
	void UpdateWidget(bool Interacting); // Function BP_InteractionWidget.BP_InteractionWidget_C.UpdateWidget // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void UserConstructionScript(); // Function BP_InteractionWidget.BP_InteractionWidget_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
};
