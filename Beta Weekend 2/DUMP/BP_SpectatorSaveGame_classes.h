...
struct UBP_SpectatorSaveGame_C : USaveGame {
	...
	void SetPreset(int32_t Index, struct TMap<struct TSoftClassPtr<UObject>, struct FFPostProcessSaveData> Preset); // Function BP_SpectatorSaveGame.BP_SpectatorSaveGame_C.SetPreset // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	struct TMap<struct TSoftClassPtr<UObject>, struct FFPostProcessSaveData> GetPreset(int32_t Index); // Function BP_SpectatorSaveGame.BP_SpectatorSaveGame_C.GetPreset // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
};
