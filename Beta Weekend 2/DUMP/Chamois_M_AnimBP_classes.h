...
struct UChamois_M_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function Chamois_M_AnimBP.Chamois_M_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	float GetIKStrength(); // Function Chamois_M_AnimBP.Chamois_M_AnimBP_C.GetIKStrength // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a38c80
	void CalcRotationRate(float CurrentYaw, float YawRotationRate); // Function Chamois_M_AnimBP.Chamois_M_AnimBP_C.CalcRotationRate // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function Chamois_M_AnimBP.Chamois_M_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void BlueprintBeginPlay(); // Function Chamois_M_AnimBP.Chamois_M_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void SetIKEnabled(bool Value); // Function Chamois_M_AnimBP.Chamois_M_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_Chamois_M_AnimBP(int32_t EntryPoint); // Function Chamois_M_AnimBP.Chamois_M_AnimBP_C.ExecuteUbergraph_Chamois_M_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
