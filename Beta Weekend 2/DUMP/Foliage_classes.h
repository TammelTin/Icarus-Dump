...
struct UFoliageInstancedStaticMeshComponent : UHierarchicalInstancedStaticMeshComponent {
	struct FMulticastInlineDelegate OnInstanceTakePointDamage; // 0x668(0x10)
	struct FMulticastInlineDelegate OnInstanceTakeRadialDamage; // 0x678(0x10)
	struct FGuid GenerationGuid; // 0x688(0x10)
};
...
struct UFoliageStatistics : UBlueprintFunctionLibrary {
	...
	int32_t FoliageOverlappingSphereCount(struct UObject* WorldContextObject, struct UStaticMesh* StaticMesh, struct FVector CenterPosition, float Radius); // Function Foliage.FoliageStatistics.FoliageOverlappingSphereCount // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x2815e10
	int32_t FoliageOverlappingBoxCount(struct UObject* WorldContextObject, struct UStaticMesh* StaticMesh, struct FBox Box); // Function Foliage.FoliageStatistics.FoliageOverlappingBoxCount // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x2815cd0
};
...
struct UFoliageType : UObject {
	...
	struct FBodyInstance BodyInstance; // 0x158(0x158)
	enum class EHasCustomNavigableGeometry CustomNavigableGeometry; // 0x2b0(0x01)
	struct FLightingChannels LightingChannels; // 0x2b1(0x01)
	char pad_2B2[0x2]; // 0x2b2(0x02)
	char bRenderCustomDepth : 1; // 0x2b4(0x01)
	char pad_2B4_1 : 7; // 0x2b4(0x01)
	char pad_2B5[0x3]; // 0x2b5(0x03)
	enum class ERendererStencilMask CustomDepthStencilWriteMask; // 0x2b8(0x01)
	char pad_2B9[0x3]; // 0x2b9(0x03)
	int32_t CustomDepthStencilValue; // 0x2bc(0x04)
	int32_t TranslucencySortPriority; // 0x2c0(0x04)
	float CollisionRadius; // 0x2c4(0x04)
	float ShadeRadius; // 0x2c8(0x04)
	int32_t NumSteps; // 0x2cc(0x04)
	float InitialSeedDensity; // 0x2d0(0x04)
	float AverageSpreadDistance; // 0x2d4(0x04)
	float SpreadVariance; // 0x2d8(0x04)
	int32_t SeedsPerStep; // 0x2dc(0x04)
	int32_t DistributionSeed; // 0x2e0(0x04)
	float MaxInitialSeedOffset; // 0x2e4(0x04)
	bool bCanGrowInShade; // 0x2e8(0x01)
	bool bSpawnsInShade; // 0x2e9(0x01)
	char pad_2EA[0x2]; // 0x2ea(0x02)
	float MaxInitialAge; // 0x2ec(0x04)
	float MaxAge; // 0x2f0(0x04)
	float OverlapPriority; // 0x2f4(0x04)
	struct FFloatInterval ProceduralScale; // 0x2f8(0x08)
	struct FRuntimeFloatCurve ScaleCurve; // 0x300(0x88)
	int32_t ChangeCount; // 0x388(0x04)
	char ReapplyDensity : 1; // 0x38c(0x01)
	char ReapplyRadius : 1; // 0x38c(0x01)
	char ReapplyAlignToNormal : 1; // 0x38c(0x01)
	char ReapplyRandomYaw : 1; // 0x38c(0x01)
	char ReapplyScaling : 1; // 0x38c(0x01)
	char ReapplyScaleX : 1; // 0x38c(0x01)
	char ReapplyScaleY : 1; // 0x38c(0x01)
	char ReapplyScaleZ : 1; // 0x38c(0x01)
	char ReapplyRandomPitchAngle : 1; // 0x38d(0x01)
	char ReapplyGroundSlope : 1; // 0x38d(0x01)
	char ReapplyHeight : 1; // 0x38d(0x01)
	char ReapplyLandscapeLayers : 1; // 0x38d(0x01)
	char ReapplyZOffset : 1; // 0x38d(0x01)
	char ReapplyCollisionWithWorld : 1; // 0x38d(0x01)
	char ReapplyVertexColorMask : 1; // 0x38d(0x01)
	char bEnableDensityScaling : 1; // 0x38d(0x01)
	char bEnableDiscardOnLoad : 1; // 0x38e(0x01)
	char pad_38E_1 : 7; // 0x38e(0x01)
	char pad_38F[0x1]; // 0x38f(0x01)
	struct TArray<struct URuntimeVirtualTexture*> RuntimeVirtualTextures; // 0x390(0x10)
	int32_t VirtualTextureCullMips; // 0x3a0(0x04)
	enum class ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType; // 0x3a4(0x01)
...
struct UFoliageType_Actor : UFoliageType {
	struct AActor* ActorClass; // 0x3a8(0x08)
...
struct UFoliageType_InstancedStaticMesh : UFoliageType {
	struct UStaticMesh* Mesh; // 0x3a8(0x08)
	struct TArray<struct UMaterialInterface*> OverrideMaterials; // 0x3b0(0x10)
	struct UFoliageInstancedStaticMeshComponent* ComponentClass; // 0x3c0(0x08)
};
...
struct AInteractiveFoliageActor : AStaticMeshActor {
	...
	struct FVector TouchingActorEntryPosition; // 0x238(0x0c)
	struct FVector FoliageVelocity; // 0x244(0x0c)
	struct FVector FoliageForce; // 0x250(0x0c)
	struct FVector FoliagePosition; // 0x25c(0x0c)
	...
	void CapsuleTouched(struct UPrimitiveComponent* OverlappedComp, struct AActor* Other, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult OverlapInfo); // Function Foliage.InteractiveFoliageActor.CapsuleTouched // (Final|Native|Protected|HasOutParms) // @ game+0x2815aa0
};
...
struct AProceduralFoliageBlockingVolume : AVolume {
	struct AProceduralFoliageVolume* ProceduralFoliageVolume; // 0x258(0x08)
};
...
struct UProceduralFoliageSpawner : UObject {
	...
	void Simulate(int32_t NumSteps); // Function Foliage.ProceduralFoliageSpawner.Simulate // (Final|Native|Public|BlueprintCallable) // @ game+0x2815f70
};
...
struct AProceduralFoliageVolume : AVolume {
	struct UProceduralFoliageComponent* ProceduralComponent; // 0x258(0x08)
};
