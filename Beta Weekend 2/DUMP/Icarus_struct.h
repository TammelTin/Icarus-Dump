...
enum class ELeaveProspectSessionType : uint8 {
	...
	LeaveByDropship = 3,
	Disconnected = 4,
	ELeaveProspectSessionType_MAX = 5
};
...
// Enum Icarus.EShelterTraceFrequency
enum class EShelterTraceFrequency : uint8 {
	Always = 0,
	AlwaysIfPlayersAreClose = 1,
	StaggeredIfPlayersAreClose = 2,
	Staggered = 3,
	EShelterTraceFrequency_MAX = 4
};
...
struct FConnectedPlayer {
	...
	bool bFriendsUpdated; // 0x41(0x01)
	char pad_42[0x6]; // 0x42(0x06)
	struct TArray<struct FFriendPackage> Friends; // 0x48(0x10)
};

// ScriptStruct Icarus.FriendPackage
// Size: 0x78 (Inherited: 0x00)
struct FFriendPackage {
	struct FString FriendUniqueID; // 0x00(0x10)
	struct FBPFriendInfo SteamFriendInfo; // 0x10(0x68)
};
...
struct FAISetup : FIcarusTableRowBase {
	...
	struct FAIGrowthRowHandle AIGrowth; // 0xd8(0x18)
	struct TMap<enum class EMovementState, struct FMovementStateData> MovementMapping; // 0xf0(0x50)
	struct FHuntingSetupRowHandle HuntingSetup; // 0x140(0x18)
	struct TArray<struct FCriticalHitLocation> CriticalHitBones; // 0x158(0x10)
	struct FAIAudioDataRowHandle Audio; // 0x168(0x18)
	struct TArray<struct FName> CollisionHitEventBones; // 0x180(0x10)
	struct FItemRewardsRowHandle Trophy; // 0x190(0x18)
	struct FItemRewardsRowHandle Loot; // 0x1a8(0x18)
	struct FItemRewardsRowHandle Hitable; // 0x1c0(0x18)
};
...
struct FAISpawnConfigData : FIcarusTableRowBase {
	...
	struct TSoftObjectPtr<UGameplayTexture> AILevelHeatmap; // 0x108(0x28)
	int32_t MinimumAILevel; // 0x130(0x04)
	int32_t MaximumAILevel; // 0x134(0x04)
	struct TSoftObjectPtr<UGameplayTexture> AILevelVarianceHeatmap; // 0x138(0x28)
	int32_t MinimumLevelVariance; // 0x160(0x04)
	int32_t MaximumLevelVariance; // 0x164(0x04)
};
...
struct FDeployableData : FIcarusTableRowBase {
	...
	bool UseSnapSocketScale; // 0xf2(0x01)
	bool bCanAffectNavigation; // 0xf3(0x01)
...
// ScriptStruct Icarus.IcarusClaimAndLaunchSessionConfirmationSetups
// Size: 0x68 (Inherited: 0x00)
struct FIcarusClaimAndLaunchSessionConfirmationSetups {
	struct UConfirmationPopupBase* ConfirmationPopup; // 0x00(0x08)
	struct FConfirmationPopupDetails Details; // 0x08(0x60)
};
...
// ScriptStruct Icarus.IcarusJoinSessionConfirmationSetups
// Size: 0x68 (Inherited: 0x00)
struct FIcarusJoinSessionConfirmationSetups {
	struct UConfirmationPopupBase* ConfirmationPopup; // 0x00(0x08)
	struct FConfirmationPopupDetails Details; // 0x08(0x60)
};
...
// ScriptStruct Icarus.IcarusResumeSessionConfirmationSetups
// Size: 0x1e8 (Inherited: 0x00)
struct FIcarusResumeSessionConfirmationSetups {
	struct UConfirmationPopupBase* ConfirmationPopup; // 0x00(0x08)
	struct FConfirmationPopupDetails ConfirmationHost; // 0x08(0x60)
	struct FConfirmationPopupDetails ConfirmationJoin; // 0x68(0x60)
	struct FConfirmationPopupDetails PostConfirmationHost; // 0xc8(0x60)
	struct FConfirmationPopupDetails PostConfirmationJoin; // 0x128(0x60)
	struct FConfirmationPopupDetails PostConfirmationMissmatch; // 0x188(0x60)
};
...
struct FItemRewardEntry {
	...
	struct FStatsRowHandle RequiredStatToDrop; // 0x1c(0x18)
	int32_t MinRandomStackCount; // 0x34(0x04)
	int32_t MaxRandomStackCount; // 0x38(0x04)
	struct FStatsRowHandle StackAdditiveStat; // 0x3c(0x18)
	struct FStatsRowHandle StackMultiplicativeStat; // 0x54(0x18)
};
...
struct FModifierStateData : FIcarusTableRowBase {
	...
	bool RemovedOnDeath; // 0x180(0x01)
	enum class EModifierMergeType MergeType; // 0x181(0x01)
	...
	bool bEffectsObjects; // 0x1f0(0x01)
	bool bEffectsNPCs; // 0x1f1(0x01)
	bool bEffectsPlayers; // 0x1f2(0x01)
	bool SaveToDatabase; // 0x1f3(0x01)
...
struct FIcarusProspect : FIcarusTableRowBase {
	...
	struct TArray<struct FProspectStatsRowHandle> WorldStatList; // 0x170(0x10)
};
