...
struct FLiveLinkSourceBufferManagementSettings {
	...
	bool bGenerateSubFrame; // 0x18(0x01)
	char pad_19[0x3]; // 0x19(0x03)
	struct FFrameRate DetectedFrameRate; // 0x1c(0x08)
	bool bUseTimecodeSmoothLatest; // 0x24(0x01)
	char pad_25[0x3]; // 0x25(0x03)
	struct FFrameRate SourceTimecodeFrameRate; // 0x28(0x08)
	bool bValidTimecodeFrameEnabled; // 0x30(0x01)
	char pad_31[0x3]; // 0x31(0x03)
	int32_t ValidTimecodeFrame; // 0x34(0x04)
	float TimecodeFrameOffset; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
	double TimecodeClockOffset; // 0x40(0x08)
	int32_t LatestOffset; // 0x48(0x04)
	int32_t MaxNumberOfFrameToBuffered; // 0x4c(0x04)
	bool bKeepAtLeastOneFrame; // 0x50(0x01)
