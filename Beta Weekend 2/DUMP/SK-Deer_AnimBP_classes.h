...
struct USK-Deer_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK-Deer_AnimBP.SK-Deer_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	float GetIKStrength(); // Function SK-Deer_AnimBP.SK-Deer_AnimBP_C.GetIKStrength // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a38c80
	void CalcRotationRate(float CurrentYaw, float YawRotationRate); // Function SK-Deer_AnimBP.SK-Deer_AnimBP_C.CalcRotationRate // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK-Deer_AnimBP.SK-Deer_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void BlueprintBeginPlay(); // Function SK-Deer_AnimBP.SK-Deer_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void SetIKEnabled(bool Value); // Function SK-Deer_AnimBP.SK-Deer_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_SK-Deer_AnimBP(int32_t EntryPoint); // Function SK-Deer_AnimBP.SK-Deer_AnimBP_C.ExecuteUbergraph_SK-Deer_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
