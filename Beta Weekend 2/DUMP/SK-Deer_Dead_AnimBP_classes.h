...
struct USK-Deer_Dead_AnimBP_C : UIcarusCorpseAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK-Deer_Dead_AnimBP.SK-Deer_Dead_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_SK-Deer_Dead_AnimBP(int32_t EntryPoint); // Function SK-Deer_Dead_AnimBP.SK-Deer_Dead_AnimBP_C.ExecuteUbergraph_SK-Deer_Dead_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
