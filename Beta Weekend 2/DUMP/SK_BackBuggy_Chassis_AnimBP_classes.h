...
struct USK_BackBuggy_Chassis_AnimBP_C : UVehicleAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_BackBuggy_Chassis_AnimBP.SK_BackBuggy_Chassis_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void UpdateSuspensionSpring(struct AVehicleBase* Vehicle, struct FName AttachSocketName, struct FName EndSocketName); // Function SK_BackBuggy_Chassis_AnimBP.SK_BackBuggy_Chassis_AnimBP_C.UpdateSuspensionSpring // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CalculateDriveSpin(struct UWheeledVehicleMovementComponent* VehicleMovement, float DeltaTime); // Function SK_BackBuggy_Chassis_AnimBP.SK_BackBuggy_Chassis_AnimBP_C.CalculateDriveSpin // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CalculateAxleAngles(struct AVehicleBase* Vehicle); // Function SK_BackBuggy_Chassis_AnimBP.SK_BackBuggy_Chassis_AnimBP_C.CalculateAxleAngles // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK_BackBuggy_Chassis_AnimBP.SK_BackBuggy_Chassis_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_SK_BackBuggy_Chassis_AnimBP(int32_t EntryPoint); // Function SK_BackBuggy_Chassis_AnimBP.SK_BackBuggy_Chassis_AnimBP_C.ExecuteUbergraph_SK_BackBuggy_Chassis_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
