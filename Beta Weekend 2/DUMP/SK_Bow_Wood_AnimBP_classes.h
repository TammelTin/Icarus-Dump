...
struct USK_Bow_Wood_AnimBP_C : UIcarusBowAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CacheFocusing(); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.CacheFocusing // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CacheHandArrowPlacement(); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.CacheHandArrowPlacement // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CacheStringPosition(); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.CacheStringPosition // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CacheThirdPerson(); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.CacheThirdPerson // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	bool IsHandConnectedToString(); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.IsHandConnectedToString // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a38c80
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	...
	void AnimNotify_Bow_AttachArrow(); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.AnimNotify_Bow_AttachArrow // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void AnimNotify_Bow_DetachArrow(); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.AnimNotify_Bow_DetachArrow // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_SK_Bow_Wood_AnimBP(int32_t EntryPoint); // Function SK_Bow_Wood_AnimBP.SK_Bow_Wood_AnimBP_C.ExecuteUbergraph_SK_Bow_Wood_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
