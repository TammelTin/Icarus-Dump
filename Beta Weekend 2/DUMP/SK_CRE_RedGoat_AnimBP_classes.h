...
struct USK_CRE_RedGoat_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_CRE_RedGoat_AnimBP.SK_CRE_RedGoat_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CalcRotationRate(float Current_Yaw, float YawRotationRate); // Function SK_CRE_RedGoat_AnimBP.SK_CRE_RedGoat_AnimBP_C.CalcRotationRate // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK_CRE_RedGoat_AnimBP.SK_CRE_RedGoat_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_SK_CRE_RedGoat_AnimBP(int32_t EntryPoint); // Function SK_CRE_RedGoat_AnimBP.SK_CRE_RedGoat_AnimBP_C.ExecuteUbergraph_SK_CRE_RedGoat_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
