...
struct USK_CRE_Wulv_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_CRE_Wulv_AnimBP.SK_CRE_Wulv_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void SetIKEnabled(bool Enabled); // Function SK_CRE_Wulv_AnimBP.SK_CRE_Wulv_AnimBP_C.SetIKEnabled // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK_CRE_Wulv_AnimBP.SK_CRE_Wulv_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void BlueprintBeginPlay(); // Function SK_CRE_Wulv_AnimBP.SK_CRE_Wulv_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void OnSetIKEnabled(bool Value); // Function SK_CRE_Wulv_AnimBP.SK_CRE_Wulv_AnimBP_C.OnSetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_SK_CRE_Wulv_AnimBP(int32_t EntryPoint); // Function SK_CRE_Wulv_AnimBP.SK_CRE_Wulv_AnimBP_C.ExecuteUbergraph_SK_CRE_Wulv_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
