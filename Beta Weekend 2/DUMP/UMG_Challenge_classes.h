...
struct UUMG_Challenge_C : UUserWidget {
	...
	void ChallengeComplete(struct FF_ChallengeState NewParam); // Function UMG_Challenge.UMG_Challenge_C.ChallengeComplete // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void SetComplete(); // Function UMG_Challenge.UMG_Challenge_C.SetComplete // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Construct(); // Function UMG_Challenge.UMG_Challenge_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_Challenge(int32_t EntryPoint); // Function UMG_Challenge.UMG_Challenge_C.ExecuteUbergraph_UMG_Challenge // (Final|UbergraphFunction) // @ game+0x1a38c80
};
