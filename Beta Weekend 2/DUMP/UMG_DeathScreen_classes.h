...
struct UUMG_DeathScreen_C : UUserWidget {
	...
	void UpdateRespawnText(); // Function UMG_DeathScreen.UMG_DeathScreen_C.UpdateRespawnText // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ResetRespawnButton(); // Function UMG_DeathScreen.UMG_DeathScreen_C.ResetRespawnButton // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UMG_DeathScreen.UMG_DeathScreen_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_DeathScreen(int32_t EntryPoint); // Function UMG_DeathScreen.UMG_DeathScreen_C.ExecuteUbergraph_UMG_DeathScreen // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
};
