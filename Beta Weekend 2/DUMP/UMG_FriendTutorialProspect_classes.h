...
struct UUMG_FriendTutorialProspect_C : UUserWidget {
	...
	void SetHasClaimedProspect(); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.SetHasClaimedProspect // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void SetTime(struct TArray<struct FString> Time); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.SetTime // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void SetState(enum class E_ProspectState NewState); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.SetState // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Update Pin Visuals(enum class E_PinState PinState); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.Update Pin Visuals // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void SetProspectInfo(struct FFProspectServerInfo Prospect); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.SetProspectInfo // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__ButtonBase_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature(); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.BndEvt__ButtonBase_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__ButtonBase_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature(); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.BndEvt__ButtonBase_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__ButtonBase_K2Node_ComponentBoundEvent_4_OnButtonPressedEvent__DelegateSignature(); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.BndEvt__ButtonBase_K2Node_ComponentBoundEvent_4_OnButtonPressedEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__ButtonBase_K2Node_ComponentBoundEvent_5_OnButtonReleasedEvent__DelegateSignature(); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.BndEvt__ButtonBase_K2Node_ComponentBoundEvent_5_OnButtonReleasedEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__ButtonBase_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature(); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.BndEvt__ButtonBase_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_FriendTutorialProspect(int32_t EntryPoint); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.ExecuteUbergraph_UMG_FriendTutorialProspect // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
	void ProspectExpired__DelegateSignature(); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.ProspectExpired__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ProspectSelected__DelegateSignature(struct FFProspectServerInfo Prospect, bool Active); // Function UMG_FriendTutorialProspect.UMG_FriendTutorialProspect_C.ProspectSelected__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
};
