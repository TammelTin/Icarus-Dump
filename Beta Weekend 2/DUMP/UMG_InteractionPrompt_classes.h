...
struct UUMG_InteractionPrompt_C : UUserWidget {
	...
	void Set Held(bool Held, struct UImage* Image, float Alpha, struct UWidgetAnimation* Animation, bool Cache); // Function UMG_InteractionPrompt.UMG_InteractionPrompt_C.Set Held // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function UMG_InteractionPrompt.UMG_InteractionPrompt_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void SetState(bool Visible); // Function UMG_InteractionPrompt.UMG_InteractionPrompt_C.SetState // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_InteractionPrompt(int32_t EntryPoint); // Function UMG_InteractionPrompt.UMG_InteractionPrompt_C.ExecuteUbergraph_UMG_InteractionPrompt // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
};
