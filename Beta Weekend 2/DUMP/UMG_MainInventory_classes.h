...
struct UUMG_MainInventory_C : UUserWidget {
	...
	enum class UDLSSMode Old DLSS Mode; // 0x388(0x01)
	char pad_389[0x7]; // 0x389(0x07)
	struct FTimerHandle TimerHandle; // 0x390(0x08)

	void IsInventoryVisibile(bool Visible); // Function UMG_MainInventory.UMG_MainInventory_C.IsInventoryVisibile // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a38c80
	void QuickShiftInventoryHandler(int32_t Location, struct UInventory* Inventory); // Function UMG_MainInventory.UMG_MainInventory_C.QuickShiftInventoryHandler // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Initialise(struct UInventory* BoundInventory, struct UInventory* EnvirosuitInventory, struct UInventory* EquipmentInventory, struct UInventory* UpgradeInventory, struct UInventory* VisionInventory, struct UUMG_UserInterface_C* Parent); // Function UMG_MainInventory.UMG_MainInventory_C.Initialise // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Construct(); // Function UMG_MainInventory.UMG_MainInventory_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ModifiersUpdated_Event_1(int32_t Modifiers); // Function UMG_MainInventory.UMG_MainInventory_C.ModifiersUpdated_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__UMG_BasicButton_K2Node_ComponentBoundEvent_2_Clicked__DelegateSignature(struct UUMG_ButtonBase_C* Button); // Function UMG_MainInventory.UMG_MainInventory_C.BndEvt__UMG_BasicButton_K2Node_ComponentBoundEvent_2_Clicked__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void VisibilityChanged(enum class ESlateVisibility NewVisbility); // Function UMG_MainInventory.UMG_MainInventory_C.VisibilityChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Set DLSS On After Time(); // Function UMG_MainInventory.UMG_MainInventory_C.Set DLSS On After Time // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_MainInventory(int32_t EntryPoint); // Function UMG_MainInventory.UMG_MainInventory_C.ExecuteUbergraph_UMG_MainInventory // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
};
