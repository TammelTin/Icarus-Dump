...
struct UUMG_MetaItemShop_C : UUMG_IcarusLinkedActorPanel_C {
	...
	void Update(); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.Update // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void PurchaseMetaItem(int32_t Index); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.PurchaseMetaItem // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void PurchaseItemConfirmed(); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.PurchaseItemConfirmed // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void PurchaseItemFailed(); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.PurchaseItemFailed // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Opened(); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.Opened // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void PurchaseOutcome(bool Success); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.PurchaseOutcome // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ShopUpdated(); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.ShopUpdated // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_MetaItemShop(int32_t EntryPoint); // Function UMG_MetaItemShop.UMG_MetaItemShop_C.ExecuteUbergraph_UMG_MetaItemShop // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
};
