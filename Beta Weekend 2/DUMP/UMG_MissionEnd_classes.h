...
struct UUMG_MissionEnd_C : UUserWidget {
	...
	void Close(); // Function UMG_MissionEnd.UMG_MissionEnd_C.Close // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void GoToNextWidget(); // Function UMG_MissionEnd.UMG_MissionEnd_C.GoToNextWidget // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void SetContentState(enum class EMissionEndScreenState State); // Function UMG_MissionEnd.UMG_MissionEnd_C.SetContentState // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void DisplayProspectInfo(struct FResGetLastProspect ProspectReward); // Function UMG_MissionEnd.UMG_MissionEnd_C.DisplayProspectInfo // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void GetPlayerIds(struct TArray<struct FPlayerID> CurrentPlayerIds); // Function UMG_MissionEnd.UMG_MissionEnd_C.GetPlayerIds // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a38c80
	void BndEvt__ProspectStats_K2Node_ComponentBoundEvent_1_Toggled__DelegateSignature(struct UUMG_ToggleButtonBase_C* ToggleButton); // Function UMG_MissionEnd.UMG_MissionEnd_C.BndEvt__ProspectStats_K2Node_ComponentBoundEvent_1_Toggled__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__PlayerRating_K2Node_ComponentBoundEvent_3_Toggled__DelegateSignature(struct UUMG_ToggleButtonBase_C* ToggleButton); // Function UMG_MissionEnd.UMG_MissionEnd_C.BndEvt__PlayerRating_K2Node_ComponentBoundEvent_3_Toggled__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void BndEvt__NextButton_K2Node_ComponentBoundEvent_4_Clicked__DelegateSignature(struct UUMG_ButtonBase_C* Button); // Function UMG_MissionEnd.UMG_MissionEnd_C.BndEvt__NextButton_K2Node_ComponentBoundEvent_4_Clicked__DelegateSignature // (BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_MissionEnd(int32_t EntryPoint); // Function UMG_MissionEnd.UMG_MissionEnd_C.ExecuteUbergraph_UMG_MissionEnd // (Final|UbergraphFunction) // @ game+0x1a38c80
	void ClosePanel__DelegateSignature(); // Function UMG_MissionEnd.UMG_MissionEnd_C.ClosePanel__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
};
