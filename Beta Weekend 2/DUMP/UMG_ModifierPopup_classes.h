...
struct UUMG_ModifierPopup_C : UUserWidget {
	...
	void Construct(); // Function UMG_ModifierPopup.UMG_ModifierPopup_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_ModifierPopup(int32_t EntryPoint); // Function UMG_ModifierPopup.UMG_ModifierPopup_C.ExecuteUbergraph_UMG_ModifierPopup // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
};
