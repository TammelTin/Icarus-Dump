...
struct UUMG_PlanetProspectView_C : UUserWidget {
	...
	void RefreshList(struct TArray<struct FFProspectServerInfo> Prospects); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.RefreshList // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void UpdateLandMassVisuals(bool Enabled, struct UImage* Landmass); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.UpdateLandMassVisuals // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Construct(); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ProspectSelectedEvent(struct FFProspectServerInfo Prospect, bool Active); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.ProspectSelectedEvent // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ProspectExpiredEvent(); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.ProspectExpiredEvent // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_PlanetProspectView(int32_t EntryPoint); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.ExecuteUbergraph_UMG_PlanetProspectView // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
	void ProspectExpired__DelegateSignature(); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.ProspectExpired__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ProspectSelected__DelegateSignature(struct FFProspectServerInfo ProspectInfo, bool Active); // Function UMG_PlanetProspectView.UMG_PlanetProspectView_C.ProspectSelected__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
};
