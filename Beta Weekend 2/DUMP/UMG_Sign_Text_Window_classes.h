...
struct UUMG_Sign_Text_Window_C : UUMG_IcarusLinkedActorPanel_C {
	...
	void Construct(); // Function UMG_Sign_Text_Window.UMG_Sign_Text_Window_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a38c80
	...
	void ExecuteUbergraph_UMG_Sign_Text_Window(int32_t EntryPoint); // Function UMG_Sign_Text_Window.UMG_Sign_Text_Window_C.ExecuteUbergraph_UMG_Sign_Text_Window // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
};
