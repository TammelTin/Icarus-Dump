...
struct UUMG_SurvivalProgress_C : UUserWidget {
	...
	void SetType(enum class ESecondaryItemTypes SurvivalType); // Function UMG_SurvivalProgress.UMG_SurvivalProgress_C.SetType // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void SetProgress(float Percent, int32_t Current, int32_t Max); // Function UMG_SurvivalProgress.UMG_SurvivalProgress_C.SetProgress // (BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_UMG_SurvivalProgress(int32_t EntryPoint); // Function UMG_SurvivalProgress.UMG_SurvivalProgress_C.ExecuteUbergraph_UMG_SurvivalProgress // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a38c80
};
