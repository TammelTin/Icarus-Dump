...
struct UVehicle_Rover_AnimBP_C : UVehicleAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function Vehicle_Rover_AnimBP.Vehicle_Rover_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void CalculeDriveAngles(struct AWheeledVehicle* Vehicle); // Function Vehicle_Rover_AnimBP.Vehicle_Rover_AnimBP_C.CalculeDriveAngles // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	void Calculate Drive Spin(struct UWheeledVehicleMovementComponent* VehicleMovement, float DeltaTime); // Function Vehicle_Rover_AnimBP.Vehicle_Rover_AnimBP_C.Calculate Drive Spin // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a38c80
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function Vehicle_Rover_AnimBP.Vehicle_Rover_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a38c80
	void ExecuteUbergraph_Vehicle_Rover_AnimBP(int32_t EntryPoint); // Function Vehicle_Rover_AnimBP.Vehicle_Rover_AnimBP_C.ExecuteUbergraph_Vehicle_Rover_AnimBP // (Final|UbergraphFunction) // @ game+0x1a38c80
};
