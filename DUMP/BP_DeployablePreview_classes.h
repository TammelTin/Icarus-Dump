...
struct ABP_DeployablePreview_C : AStaticMeshActor {
	...
	void ToggleRotationIndicator(bool Enabled, bool SnappingAvailable); // Function BP_DeployablePreview.BP_DeployablePreview_C.ToggleRotationIndicator // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void UserConstructionScript(); // Function BP_DeployablePreview.BP_DeployablePreview_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
};
