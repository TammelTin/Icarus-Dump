...
struct ABP_InteractableLake_C : ALake {
	...
	void SetUpEdgeSpline(); // Function BP_InteractableLake.BP_InteractableLake_C.SetUpEdgeSpline // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void SetupGOAPWaterNodes(); // Function BP_InteractableLake.BP_InteractableLake_C.SetupGOAPWaterNodes // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void UserConstructionScript(); // Function BP_InteractableLake.BP_InteractableLake_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void OnLoaded_B607BE074B40775DC6E9828DC398DAE2(struct UObject* Loaded); // Function BP_InteractableLake.BP_InteractableLake_C.OnLoaded_B607BE074B40775DC6E9828DC398DAE2 // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	...
	void ReceiveBeginPlay(); // Function BP_InteractableLake.BP_InteractableLake_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_BP_InteractableLake(int32_t EntryPoint); // Function BP_InteractableLake.BP_InteractableLake_C.ExecuteUbergraph_BP_InteractableLake // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
