...
struct ABP_MetaDeposit_Conifer_C : ABP_MetaDeposit_C {
	...
	void Timeline_FadeOut__FinishedFunc(); // Function BP_MetaDeposit_Conifer.BP_MetaDeposit_Conifer_C.Timeline_FadeOut__FinishedFunc // (BlueprintEvent) // @ game+0x1a05090
	void Timeline_FadeOut__UpdateFunc(); // Function BP_MetaDeposit_Conifer.BP_MetaDeposit_Conifer_C.Timeline_FadeOut__UpdateFunc // (BlueprintEvent) // @ game+0x1a05090
	void ResourceEmptied(); // Function BP_MetaDeposit_Conifer.BP_MetaDeposit_Conifer_C.ResourceEmptied // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_BP_MetaDeposit_Conifer(int32_t EntryPoint); // Function BP_MetaDeposit_Conifer.BP_MetaDeposit_Conifer_C.ExecuteUbergraph_BP_MetaDeposit_Conifer // (Final|UbergraphFunction) // @ game+0x1a05090
};
