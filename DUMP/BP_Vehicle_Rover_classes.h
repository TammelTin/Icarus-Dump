...
struct ABP_Vehicle_Rover_C : ABP_Vehicle4W_C {
	...
	void OnRep_ExhaustActive(); // Function BP_Vehicle_Rover.BP_Vehicle_Rover_C.OnRep_ExhaustActive // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void OnRep_BrakelightActive(); // Function BP_Vehicle_Rover.BP_Vehicle_Rover_C.OnRep_BrakelightActive // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void UpdateHeadlightMaterial(); // Function BP_Vehicle_Rover.BP_Vehicle_Rover_C.UpdateHeadlightMaterial // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void UpdateBrakelightMaterial(); // Function BP_Vehicle_Rover.BP_Vehicle_Rover_C.UpdateBrakelightMaterial // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void OnRep_HeadlightActive(); // Function BP_Vehicle_Rover.BP_Vehicle_Rover_C.OnRep_HeadlightActive // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ReceiveTick(float DeltaSeconds); // Function BP_Vehicle_Rover.BP_Vehicle_Rover_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_BP_Vehicle_Rover(int32_t EntryPoint); // Function BP_Vehicle_Rover.BP_Vehicle_Rover_C.ExecuteUbergraph_BP_Vehicle_Rover // (Final|UbergraphFunction) // @ game+0x1a05090
};
