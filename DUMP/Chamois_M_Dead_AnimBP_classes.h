...
struct UChamois_M_Dead_AnimBP_C : UIcarusCorpseAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function Chamois_M_Dead_AnimBP.Chamois_M_Dead_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_Chamois_M_Dead_AnimBP(int32_t EntryPoint); // Function Chamois_M_Dead_AnimBP.Chamois_M_Dead_AnimBP_C.ExecuteUbergraph_Chamois_M_Dead_AnimBP // (Final|UbergraphFunction) // @ game+0x1a05090
};
