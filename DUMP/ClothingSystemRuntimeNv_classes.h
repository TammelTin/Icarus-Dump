...
struct UClothingSimulationInteractorNv : UClothingSimulationInteractor {
	...
	void SetAnimDriveDamperStiffness(float InStiffness); // Function ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness // (Final|Native|Public|BlueprintCallable) // @ game+0x34ca4a0
};
