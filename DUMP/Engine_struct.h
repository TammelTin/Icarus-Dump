...
struct FHitResult {
	...
	struct FName BoneName; // 0x7c(0x08)
	struct FName MyBoneName; // 0x84(0x08)
};
...
struct FBodyInstance : FBodyInstanceCore {
	...
	char PositionSolverIterationCount; // 0x74(0x01)
	char VelocitySolverIterationCount; // 0x75(0x01)
	char pad_76[0x2]; // 0x76(0x02)
	struct FCollisionResponse CollisionResponses; // 0x78(0x30)
	float MaxDepenetrationVelocity; // 0xa8(0x04)
	float MassInKgOverride; // 0xac(0x04)
	char pad_B0[0x8]; // 0xb0(0x08)
	float LinearDamping; // 0xb8(0x04)
	float AngularDamping; // 0xbc(0x04)
	struct FVector CustomDOFPlaneNormal; // 0xc0(0x0c)
	struct FVector COMNudge; // 0xcc(0x0c)
	float MassScale; // 0xd8(0x04)
	struct FVector InertiaTensorScale; // 0xdc(0x0c)
	char pad_E8[0x10]; // 0xe8(0x10)
	struct FWalkableSlopeOverride WalkableSlopeOverride; // 0xf8(0x10)
	struct UPhysicalMaterial* PhysMaterialOverride; // 0x108(0x08)
	float MaxAngularVelocity; // 0x110(0x04)
	float CustomSleepThresholdMultiplier; // 0x114(0x04)
	float StabilizationThresholdMultiplier; // 0x118(0x04)
	float PhysicsBlendWeight; // 0x11c(0x04)
...
// Size: 0x760 (Inherited: 0x00)
struct FAnimInstanceProxy {
	char pad_0[0x760]; // 0x00(0x760)
};
...
struct FAnimNode_AssetPlayerBase : FAnimNode_Base {
	...
	enum class EAnimGroupRole GroupRole; // 0x18(0x01)
	enum class EAnimSyncGroupScope GroupScope; // 0x19(0x01)
	bool bIgnoreForRelevancyTest; // 0x1a(0x01)
	char pad_1B[0x1]; // 0x1b(0x01)
	float BlendWeight; // 0x1c(0x04)
	float InternalTimeAccumulator; // 0x20(0x04)
...
struct FKShapeElem {
	...
	enum class ECollisionEnabled CollisionEnabled; // 0x19(0x01)
...
struct FAnimationGroupReference {
	...
	enum class EAnimSyncGroupScope GroupScope; // 0x09(0x01)
...
struct FAnimMontageInstance {
	...
	char pad_160[0x2c]; // 0x160(0x2c)
	int32_t DisableRootMotionCount; // 0x18c(0x04)
...
struct FAnimNode_LinkedAnimGraph : FAnimNode_CustomProperty {
	...
	char pad_88[0x14]; // 0x88(0x14)
	char bReceiveNotifiesFromLinkedInstances : 1; // 0x9c(0x01)
	char bPropagateNotifiesToLinkedInstances : 1; // 0x9c(0x01)
...
struct FEdGraphPinType {
	...
	char bIsUObjectWrapper : 1; // 0x55(0x01)
	char pad_55_5 : 3; // 0x55(0x01)
...
struct FEdGraphTerminalType {
	...
	bool bTerminalIsUObjectWrapper; // 0x1a(0x01)
	char pad_1B[0x1]; // 0x1b(0x01)
};
...
struct FMinimalViewInfo {
	...
	struct FVector2D OffCenterProjectionOffset; // 0x590(0x08)
...
struct FPostProcessSettings {
	...
	float ToneCurveAmount; // 0x180(0x04)
	float FilmSlope; // 0x184(0x04)
	float FilmToe; // 0x188(0x04)
	float FilmShoulder; // 0x18c(0x04)
	float FilmBlackClip; // 0x190(0x04)
	float FilmWhiteClip; // 0x194(0x04)
	struct FLinearColor FilmWhitePoint; // 0x198(0x10)
	struct FLinearColor FilmShadowTint; // 0x1a8(0x10)
	float FilmShadowTintBlend; // 0x1b8(0x04)
	float FilmShadowTintAmount; // 0x1bc(0x04)
	float FilmSaturation; // 0x1c0(0x04)
	...
	float FilmContrast; // 0x1f4(0x04)
	float FilmToeAmount; // 0x1f8(0x04)
	float FilmHealAmount; // 0x1fc(0x04)
	float FilmDynamicRange; // 0x200(0x04)
	struct FLinearColor SceneColorTint; // 0x204(0x10)
	float SceneFringeIntensity; // 0x214(0x04)
	float ChromaticAberrationStartOffset; // 0x218(0x04)
	float BloomIntensity; // 0x21c(0x04)
	float BloomThreshold; // 0x220(0x04)
	float BloomSizeScale; // 0x224(0x04)
	float Bloom1Size; // 0x228(0x04)
	float Bloom2Size; // 0x22c(0x04)
	float Bloom3Size; // 0x230(0x04)
	float Bloom4Size; // 0x234(0x04)
	float Bloom5Size; // 0x238(0x04)
	float Bloom6Size; // 0x23c(0x04)
	...
	float BloomConvolutionSize; // 0x2a0(0x04)
	char pad_2A4[0x4]; // 0x2a4(0x04)
	struct UTexture2D* BloomConvolutionTexture; // 0x2a8(0x08)
	struct FVector2D BloomConvolutionCenterUV; // 0x2b0(0x08)
	float BloomConvolutionPreFilterMin; // 0x2b8(0x04)
	float BloomConvolutionPreFilterMax; // 0x2bc(0x04)
	float BloomConvolutionPreFilterMult; // 0x2c0(0x04)
	float BloomConvolutionBufferScale; // 0x2c4(0x04)
	struct UTexture* BloomDirtMask; // 0x2c8(0x08)
	float BloomDirtMaskIntensity; // 0x2d0(0x04)
	struct FLinearColor BloomDirtMaskTint; // 0x2d4(0x10)
	struct FLinearColor AmbientCubemapTint; // 0x2e4(0x10)
	float AmbientCubemapIntensity; // 0x2f4(0x04)
	struct UTextureCube* AmbientCubemap; // 0x2f8(0x08)
	float CameraShutterSpeed; // 0x300(0x04)
	float CameraISO; // 0x304(0x04)
	float DepthOfFieldFstop; // 0x308(0x04)
	float DepthOfFieldMinFstop; // 0x30c(0x04)
	int32_t DepthOfFieldBladeCount; // 0x310(0x04)
	float AutoExposureBias; // 0x314(0x04)
	float AutoExposureBiasBackup; // 0x318(0x04)
	char bOverride_AutoExposureBiasBackup : 1; // 0x31c(0x01)
	char pad_31C_1 : 7; // 0x31c(0x01)
	char pad_31D[0x3]; // 0x31d(0x03)
	char AutoExposureApplyPhysicalCameraExposure : 1; // 0x320(0x01)
	char pad_320_1 : 7; // 0x320(0x01)
	char pad_321[0x7]; // 0x321(0x07)
	struct UCurveFloat* AutoExposureBiasCurve; // 0x328(0x08)
	struct UTexture* AutoExposureMeterMask; // 0x330(0x08)
	float AutoExposureLowPercent; // 0x338(0x04)
	float AutoExposureHighPercent; // 0x33c(0x04)
	float AutoExposureMinBrightness; // 0x340(0x04)
	float AutoExposureMaxBrightness; // 0x344(0x04)
	float AutoExposureSpeedUp; // 0x348(0x04)
	float AutoExposureSpeedDown; // 0x34c(0x04)
	float HistogramLogMin; // 0x350(0x04)
	float HistogramLogMax; // 0x354(0x04)
	float AutoExposureCalibrationConstant; // 0x358(0x04)
	float LensFlareIntensity; // 0x35c(0x04)
	struct FLinearColor LensFlareTint; // 0x360(0x10)
	float LensFlareBokehSize; // 0x370(0x04)
	float LensFlareThreshold; // 0x374(0x04)
	struct UTexture* LensFlareBokehShape; // 0x378(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x380(0x80)
	float VignetteIntensity; // 0x400(0x04)
	float GrainJitter; // 0x404(0x04)
	float GrainIntensity; // 0x408(0x04)
	float AmbientOcclusionIntensity; // 0x40c(0x04)
	float AmbientOcclusionStaticFraction; // 0x410(0x04)
	float AmbientOcclusionRadius; // 0x414(0x04)
	char AmbientOcclusionRadiusInWS : 1; // 0x418(0x01)
	char pad_418_1 : 7; // 0x418(0x01)
	char pad_419[0x3]; // 0x419(0x03)
	float AmbientOcclusionFadeDistance; // 0x41c(0x04)
	float AmbientOcclusionFadeRadius; // 0x420(0x04)
	float AmbientOcclusionDistance; // 0x424(0x04)
	float AmbientOcclusionPower; // 0x428(0x04)
	float AmbientOcclusionBias; // 0x42c(0x04)
	float AmbientOcclusionQuality; // 0x430(0x04)
	float AmbientOcclusionMipBlend; // 0x434(0x04)
	float AmbientOcclusionMipScale; // 0x438(0x04)
	float AmbientOcclusionMipThreshold; // 0x43c(0x04)
	float AmbientOcclusionTemporalBlendWeight; // 0x440(0x04)
	char RayTracingAO : 1; // 0x444(0x01)
	char pad_444_1 : 7; // 0x444(0x01)
	char pad_445[0x3]; // 0x445(0x03)
	int32_t RayTracingAOSamplesPerPixel; // 0x448(0x04)
	float RayTracingAOIntensity; // 0x44c(0x04)
	float RayTracingAORadius; // 0x450(0x04)
	struct FLinearColor IndirectLightingColor; // 0x454(0x10)
	float IndirectLightingIntensity; // 0x464(0x04)
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x468(0x01)
	char pad_469[0x3]; // 0x469(0x03)
	int32_t RayTracingGIMaxBounces; // 0x46c(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x470(0x04)
	float ColorGradingIntensity; // 0x474(0x04)
	struct UTexture* ColorGradingLUT; // 0x478(0x08)
	float DepthOfFieldSensorWidth; // 0x480(0x04)
	float DepthOfFieldFocalDistance; // 0x484(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x488(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x48c(0x04)
	float DepthOfFieldFocalRegion; // 0x490(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x494(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x498(0x04)
	float DepthOfFieldScale; // 0x49c(0x04)
	float DepthOfFieldNearBlurSize; // 0x4a0(0x04)
	float DepthOfFieldFarBlurSize; // 0x4a4(0x04)
	float DepthOfFieldOcclusion; // 0x4a8(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x4ac(0x04)
	float DepthOfFieldVignetteSize; // 0x4b0(0x04)
	float MotionBlurAmount; // 0x4b4(0x04)
	float MotionBlurMax; // 0x4b8(0x04)
	int32_t MotionBlurTargetFPS; // 0x4bc(0x04)
	float MotionBlurPerObjectSize; // 0x4c0(0x04)
	float LPVIntensity; // 0x4c4(0x04)
	float LPVVplInjectionBias; // 0x4c8(0x04)
	float LPVSize; // 0x4cc(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x4d0(0x04)
	float LPVSecondaryBounceIntensity; // 0x4d4(0x04)
	float LPVGeometryVolumeBias; // 0x4d8(0x04)
	float LPVEmissiveInjectionIntensity; // 0x4dc(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x4e0(0x04)
	float LPVDirectionalOcclusionRadius; // 0x4e4(0x04)
	float LPVDiffuseOcclusionExponent; // 0x4e8(0x04)
	float LPVSpecularOcclusionExponent; // 0x4ec(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x4f0(0x04)
	float LPVSpecularOcclusionIntensity; // 0x4f4(0x04)
	enum class EReflectionsType ReflectionsType; // 0x4f8(0x01)
	char pad_4F9[0x3]; // 0x4f9(0x03)
	float ScreenSpaceReflectionIntensity; // 0x4fc(0x04)
	float ScreenSpaceReflectionQuality; // 0x500(0x04)
	float ScreenSpaceReflectionMaxRoughness; // 0x504(0x04)
	float RayTracingReflectionsMaxRoughness; // 0x508(0x04)
	int32_t RayTracingReflectionsMaxBounces; // 0x50c(0x04)
	int32_t RayTracingReflectionsSamplesPerPixel; // 0x510(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingReflectionsShadows; // 0x514(0x01)
	char RayTracingReflectionsTranslucency : 1; // 0x515(0x01)
	char pad_515_1 : 7; // 0x515(0x01)
	enum class ETranslucencyType TranslucencyType; // 0x516(0x01)
	char pad_517[0x1]; // 0x517(0x01)
	float RayTracingTranslucencyMaxRoughness; // 0x518(0x04)
	int32_t RayTracingTranslucencyRefractionRays; // 0x51c(0x04)
	int32_t RayTracingTranslucencySamplesPerPixel; // 0x520(0x04)
	enum class EReflectedAndRefractedRayTracedShadows RayTracingTranslucencyShadows; // 0x524(0x01)
	char RayTracingTranslucencyRefraction : 1; // 0x525(0x01)
	char pad_525_1 : 7; // 0x525(0x01)
	char pad_526[0x2]; // 0x526(0x02)
	int32_t PathTracingMaxBounces; // 0x528(0x04)
	int32_t PathTracingSamplesPerPixel; // 0x52c(0x04)
	float LPVFadeRange; // 0x530(0x04)
	float LPVDirectionalOcclusionFadeRange; // 0x534(0x04)
	float ScreenPercentage; // 0x538(0x04)
	char pad_53C[0x4]; // 0x53c(0x04)
	struct FWeightedBlendables WeightedBlendables; // 0x540(0x10)
};
...
struct FFindFloorResult {
	...
	struct FHitResult HitResult; // 0x0c(0x8c)
};
...
struct FChildActorComponentInstanceData : FSceneComponentInstanceData {
	...
	struct FName ChildActorName; // 0xc0(0x08)
...
struct FConstraintInstance : FConstraintInstanceBase {
	...
	struct FConstraintProfileProperties ProfileInstance; // 0x8c(0x10c)
...
struct FBakedFloatCustomAttribute {
	...
	struct FSimpleCurve FloatCurve; // 0x08(0x88)
};
...
struct FBakedIntegerCustomAttribute {
	struct FName AttributeName; // 0x00(0x08)
	struct FIntegralCurve IntCurve; // 0x08(0x80)
};
...
struct FBakedStringCustomAttribute {
	struct FName AttributeName; // 0x00(0x08)
	struct FStringCurve StringCurve; // 0x08(0x88)
};
...
struct FPointDamageEvent : FDamageEvent {
	...
	struct FHitResult HitInfo; // 0x20(0x8c)
...
struct FPredictProjectilePathResult {
	...
	struct FHitResult HitResult; // 0x2c(0x8c)
};
...
struct FComponentSync {
	struct FName Name; // 0x00(0x08)
	enum class ESyncOption SyncOption; // 0x08(0x01)
	char pad_9[0x3]; // 0x09(0x03)
};
...
struct FPhysicsConstraintProfileHandle {
	...
	struct FName ProfileName; // 0x10c(0x08)
};
...
struct FTViewTarget {
	...
	char pad_8[0x8]; // 0x08(0x08)
	struct FMinimalViewInfo POV; // 0x10(0x5e0)
	struct APlayerState* PlayerState; // 0x5f0(0x08)
...
struct FTextureLODGroup {
	...
	float Downscale; // 0x54(0x04)
	enum class ETextureDownscaleOptions DownscaleOptions; // 0x58(0x01)
	char pad_59[0x3]; // 0x59(0x03)
	int32_t VirtualTextureTileCountBias; // 0x5c(0x04)
	int32_t VirtualTextureTileSizeBias; // 0x60(0x04)
};
