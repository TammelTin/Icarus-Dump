...
struct UMammoth_M_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function Mammoth_M_AnimBP.Mammoth_M_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function Mammoth_M_AnimBP.Mammoth_M_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void BlueprintBeginPlay(); // Function Mammoth_M_AnimBP.Mammoth_M_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void SetIKEnabled(bool Value); // Function Mammoth_M_AnimBP.Mammoth_M_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_Mammoth_M_AnimBP(int32_t EntryPoint); // Function Mammoth_M_AnimBP.Mammoth_M_AnimBP_C.ExecuteUbergraph_Mammoth_M_AnimBP // (Final|UbergraphFunction) // @ game+0x1a05090
};
