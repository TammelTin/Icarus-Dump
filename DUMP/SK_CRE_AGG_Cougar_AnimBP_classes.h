...
struct USK_CRE_AGG_Cougar_AnimBP_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_CRE_AGG_Cougar_AnimBP.SK_CRE_AGG_Cougar_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	float GetIKStrength(); // Function SK_CRE_AGG_Cougar_AnimBP.SK_CRE_AGG_Cougar_AnimBP_C.GetIKStrength // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x1a05090
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function SK_CRE_AGG_Cougar_AnimBP.SK_CRE_AGG_Cougar_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void BlueprintBeginPlay(); // Function SK_CRE_AGG_Cougar_AnimBP.SK_CRE_AGG_Cougar_AnimBP_C.BlueprintBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void SetIKEnabled(bool Value); // Function SK_CRE_AGG_Cougar_AnimBP.SK_CRE_AGG_Cougar_AnimBP_C.SetIKEnabled // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_SK_CRE_AGG_Cougar_AnimBP(int32_t EntryPoint); // Function SK_CRE_AGG_Cougar_AnimBP.SK_CRE_AGG_Cougar_AnimBP_C.ExecuteUbergraph_SK_CRE_AGG_Cougar_AnimBP // (Final|UbergraphFunction) // @ game+0x1a05090
};
