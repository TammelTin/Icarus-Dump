...
struct USK_CRE_RedGoat_Dead_AnimBP_C : UIcarusCorpseAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function SK_CRE_RedGoat_Dead_AnimBP.SK_CRE_RedGoat_Dead_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_SK_CRE_RedGoat_Dead_AnimBP(int32_t EntryPoint); // Function SK_CRE_RedGoat_Dead_AnimBP.SK_CRE_RedGoat_Dead_AnimBP_C.ExecuteUbergraph_SK_CRE_RedGoat_Dead_AnimBP // (Final|UbergraphFunction) // @ game+0x1a05090
};
