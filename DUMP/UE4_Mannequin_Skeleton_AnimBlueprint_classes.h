...
struct UUE4_Mannequin_Skeleton_AnimBlueprint_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function UE4_Mannequin_Skeleton_AnimBlueprint.UE4_Mannequin_Skeleton_AnimBlueprint_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function UE4_Mannequin_Skeleton_AnimBlueprint.UE4_Mannequin_Skeleton_AnimBlueprint_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_UE4_Mannequin_Skeleton_AnimBlueprint(int32_t EntryPoint); // Function UE4_Mannequin_Skeleton_AnimBlueprint.UE4_Mannequin_Skeleton_AnimBlueprint_C.ExecuteUbergraph_UE4_Mannequin_Skeleton_AnimBlueprint // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
