...
struct UUMG_Challenges_C : UUserWidget {
	...
	void Construct(); // Function UMG_Challenges.UMG_Challenges_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ChallengesUpdated(); // Function UMG_Challenges.UMG_Challenges_C.ChallengesUpdated // (BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_UMG_Challenges(int32_t EntryPoint); // Function UMG_Challenges.UMG_Challenges_C.ExecuteUbergraph_UMG_Challenges // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
