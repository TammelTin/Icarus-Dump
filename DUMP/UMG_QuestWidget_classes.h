...
struct UUMG_QuestWidget_C : UUMG_IcarusLinkedActorPanel_C {
	...
	void Construct(); // Function UMG_QuestWidget.UMG_QuestWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_UMG_QuestWidget(int32_t EntryPoint); // Function UMG_QuestWidget.UMG_QuestWidget_C.ExecuteUbergraph_UMG_QuestWidget // (Final|UbergraphFunction|HasDefaults) // @ game+0x1a05090
};
