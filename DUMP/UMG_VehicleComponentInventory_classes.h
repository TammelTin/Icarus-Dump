...
struct UUMG_VehicleComponentInventory_C : UUMG_IcarusLinkedActorPanel_C {
	...
	void DisableVehicleComponentSet(int32_t VehicleComponentSetIndex); // Function UMG_VehicleComponentInventory.UMG_VehicleComponentInventory_C.DisableVehicleComponentSet // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void InventoryQuickShiftHandler(int32_t Location, struct UInventoryComponent* Inventory); // Function UMG_VehicleComponentInventory.UMG_VehicleComponentInventory_C.InventoryQuickShiftHandler // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void InitialiseVehicleComponentSet(int32_t VehicleComponentSetIndex, struct FString Title, struct TArray<enum class EVehicleComponentType> VehicleComponentTypes, int32_t VehicleComponentsTypeIndex); // Function UMG_VehicleComponentInventory.UMG_VehicleComponentInventory_C.InitialiseVehicleComponentSet // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void Initialise(); // Function UMG_VehicleComponentInventory.UMG_VehicleComponentInventory_C.Initialise // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x1a05090
	void Construct(); // Function UMG_VehicleComponentInventory.UMG_VehicleComponentInventory_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_UMG_VehicleComponentInventory(int32_t EntryPoint); // Function UMG_VehicleComponentInventory.UMG_VehicleComponentInventory_C.ExecuteUbergraph_UMG_VehicleComponentInventory // (Final|UbergraphFunction) // @ game+0x1a05090
};
