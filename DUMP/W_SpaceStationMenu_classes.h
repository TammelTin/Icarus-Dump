...
struct UW_SpaceStationMenu_C : UW_StationInteractionWidget_C {
	...
	void BndEvt__Button_Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature(); // Function W_SpaceStationMenu.W_SpaceStationMenu_C.BndEvt__Button_Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature // (BlueprintEvent) // @ game+0x1a05090
	void ExecuteUbergraph_W_SpaceStationMenu(int32_t EntryPoint); // Function W_SpaceStationMenu.W_SpaceStationMenu_C.ExecuteUbergraph_W_SpaceStationMenu // (Final|UbergraphFunction) // @ game+0x1a05090
};
